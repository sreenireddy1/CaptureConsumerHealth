...
# TESTING DATA
tr=pd.read_csv("Testing_Predict.csv")
...
# TRAINING DATA
df=pd.read_csv("Training_Predict.csv")
...
6:'Peptic ulcer diseae',7:'AIDS',8:'Diabetes ',9:'Gastroenteritis',10:'Bronchial Asthma',11:'Hypertension ',
...
Dict1= { 21: 'Shamsabad', 15:'Kukatpally',6:'HITEC City',22:'Secunderabad',6:'Jubilee Hills',13:'Banjara Hills',
21:'Amberpet',15:'Abids',32:'Alwal',17:'Attapur',15:'Bharat Nagar', 40:'Champapet', 14:'Asif Nagar',
35:'Mallapur', 30:'Uppal',6:'Jubilee Hills',22:'Secunderabad'}
...
def NaiveBayes(s1,s2,s3,s4,s5):
    ...
    b=(accuracy_score(y_test, y_pred, normalize=False))
    ...
    if (h=='yes'):
        ...
        col_1=(get_key(disease[a]))
        # to go to flask and show output
        print(disease[a])
        cad=[]
        cad.append(col_1)
        rows = [cad]
        filename = "Testing_Doctor_Details.csv"
